...
const EgameCasino = ()=>{
  ...
  return(
    <div>
      <DarkFilter activeItem="Egame" onActiveItemChange={handleActiveItemChange}/>
      <div className=" p-2">
      <TopFilter activeItem="Egame" onActiveItemChange={handleActiveItemChange} />
