...
const FishingCasino = ()=>{
  ...
  return(
    <div>
      <DarkFilter activeItem="Fishing" onActiveItemChange={handleActiveItemChange}/>
      <div className=" p-2">
      <TopFilter activeItem="Fishing" onActiveItemChange={handleActiveItemChange} />
