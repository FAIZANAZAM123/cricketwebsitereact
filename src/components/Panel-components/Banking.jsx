...
const Banking= ()=> {
  return(
    <div className=" w-full flex flex-col space-y-4 py-5">
      ...
      <div className=" mx-auto p-1 bg-slate-400 rounded flex gap-1 items-center">
        <div className=" bg-white text-black px-2 rounded"><Input placeholder="Password"/></div>
        <button className=" px-4 py-1 bg-primary text-black hover:text-white rounded text-base font-semibold">Confirm Payment</button>
      </div>
    </div>
  )
}
